...
const EXPERTS: Expert[] = [
  ...
  { id: 'designer', name: 'Georgia', color: 'var(--exp-designer)', specialty: 'Designer — images & posters', personality: 'Creative, opinionated', model: 'gemini-3.1-flash-lite-preview', family: 'gemini' },
  { id: 'translator', name: 'Louise', color: 'var(--exp-translator)', specialty: 'Translator — any language pair', personality: 'Precise, culturally aware', model: 'gemini-3.1-flash-lite-preview', family: 'gemini' },
  { id: 'editor', name: 'Miranda', color: 'var(--exp-editor)', specialty: 'Editor — summarize & condense', personality: 'Structured, no padding', model: 'gemini-3.1-pro', family: 'gemini' },
...
const ROLE_BINDINGS: RoleBinding[] = [
  ...
  { id: 'designer', family: 'gemini', model: 'gemini-3.1-flash-lite-preview' },
  { id: 'translator', family: 'gemini', model: 'gemini-3.1-flash-lite-preview' },
  { id: 'editor', family: 'gemini', model: 'gemini-3.1-pro' },
