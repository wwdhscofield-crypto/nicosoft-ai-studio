...
const EXPERTS: Expert[] = [
  ...
  { id: 'designer', name: 'Georgia', color: 'var(--exp-designer)', specialty: 'Designer — images & posters', personality: 'Creative, opinionated', model: 'gemini-3.5-flash', family: 'gemini' },
  { id: 'translator', name: 'Louise', color: 'var(--exp-translator)', specialty: 'Translator — any language pair', personality: 'Precise, culturally aware', model: 'gemini-3.5-flash', family: 'gemini' },
...
const ROLE_BINDINGS: RoleBinding[] = [
  ...
  { id: 'designer', family: 'gemini', model: 'gemini-3.5-flash' },
  { id: 'translator', family: 'gemini', model: 'gemini-3.5-flash' },
